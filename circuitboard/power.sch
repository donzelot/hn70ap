...
U 1 1 595F3541
P 1900 3000
F 0 "#PWR0145" H 1900 3000 30  0001 C CNN
...
F 2 "apdep:MSOP-16-1EPHOLE_3x4mm_Pitch0.5mm" H 5200 2800 45  0001 C CNN
...
U 1 1 595F3A30
P 5700 3800
F 0 "#PWR0146" H 5700 3800 30  0001 C CNN
...
U 1 1 595F3CB9
P 6000 3900
F 0 "#PWR0147" H 6000 3900 30  0001 C CNN
...
U 1 1 595F3D54
P 6000 2600
F 0 "#PWR0148" H 6000 2600 30  0001 C CNN
...
F 1 "PMEG4010CEH" H 2200 2916 40  0000 C CNN
...
U 1 1 595F5255
P 4100 3200
F 0 "#PWR0149" H 4100 3200 30  0001 C CNN
...
U 1 1 595F5990
P 4800 2900
F 0 "#PWR0150" H 4800 2900 30  0001 C CNN
...
U 1 1 595F5AEF
P 4550 2200
F 0 "#PWR0151" H 4550 2200 30  0001 C CNN
...
F 3 "http://www.farnell.com/datasheets/2277283.pdf" H 6500 3300 60  0001 C CNN
F 4 "74406043100" H 6500 3300 60  0001 C CNN "Device"
	1    6500 3300
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 595F6D28
P 6750 3600
F 0 "#PWR0152" H 6750 3600 30  0001 C CNN
...
F 3 "" H 6750 3600 60  0000 C CNN
	...
	1    0    0    -1  
$EndComp
Text HLabel 9000 3300 2    45   Input ~ 0
5VOUT
...
F 1 "36103205" H 5171 4390 45  0000 C CNN
...
U 1 1 598AB41D
P 5300 4300
F 0 "#PWR0153" H 5300 4300 30  0001 C CNN
...
U 1 1 598DF93D
P 7250 3600
F 0 "D602" V 7204 3678 50  0000 L CNN
F 1 "LED" V 7295 3678 50  0000 L CNN
F 2 "apdep:0805_m2012" H 7250 3600 60  0001 C CNN
...
U 1 1 598DFA05
P 7250 3950
F 0 "R607" H 7250 4000 30  0000 C CNN
F 1 "470R" H 7250 3950 30  0000 C CNN
F 2 "apdep:0603_m1608" H 7250 3950 60  0001 C CNN
...
U 1 1 598DFA9F
P 7250 4100
F 0 "#PWR0154" H 7250 4100 30  0001 C CNN
...
U 1 1 59C16159
P 8150 3700
F 0 "C608" H 8072 3670 30  0000 R CNN
F 1 "33u" H 8072 3730 30  0000 R CNN
F 2 "apdep:1206_m3216" H 8150 3700 60  0001 C CNN
...
U 1 1 59C16259
P 8150 3800
F 0 "#PWR0155" H 8150 3800 30  0001 C CNN
...
F 3 "" H 8150 3800 60  0000 C CNN
	...
	1    0    0    -1  
$EndComp
Text Notes 8100 4050 0    45   ~ 0
At end of 5V line
Text Notes 3050 4000 0    45   ~ 0
R602/RT: Oscillator control\nRT = 9E10 / f0\n90.9k -> f0=9e10/90900 ~~ 1 MHz
Text Notes 3600 2450 0    45   ~ 0
Feedback\nVout = 0.6(1+R1/R2)
$Comp
L GND #PWR0156
U 1 1 59CCDBE0
P 5600 3100
F 0 "#PWR0156" H 5600 3100 30  0001 C CNN
...
F 3 "" H 5600 3100 60  0000 C CNN
	...
	0    -1   -1   0   
$EndComp
Text Label 4550 3100 0    45   ~ 0
INTVCC
$Comp
L GND #PWR0157
U 1 1 595F49CF
P 4500 3800
F 0 "#PWR0157" H 4500 3800 30  0001 C CNN
...
Text Notes 7000 3100 0    45   ~ 0
NOTE: IF USING LDO U506 FOR RF4463 MODULE,\nSET FB RESISTORS R604/R605 FOR 5V5 INSTEAD OF 5V
$Comp
L CSMALL C601
U 1 1 5A186080
P 8500 3700
F 0 "C601" H 8422 3670 30  0000 R CNN
F 1 "100u" H 8422 3730 30  0000 R CNN
F 2 "apdep:CP_Tantalum_Case-V_EIA-7343-20_Reflow" H 8500 3700 60  0001 C CNN
...
U 1 1 5A186086
P 8500 3800
F 0 "#PWR0158" H 8500 3800 30  0001 C CNN
...
U 1 1 5A186AF5
P 8850 3700
F 0 "C609" H 8772 3670 30  0000 R CNN
F 1 "100u" H 8772 3730 30  0000 R CNN
F 2 "apdep:CP_Tantalum_Case-V_EIA-7343-20_Reflow" H 8850 3700 60  0001 C CNN
...
U 1 1 5A186AFB
P 8850 3800
F 0 "#PWR0159" H 8850 3800 30  0001 C CNN
